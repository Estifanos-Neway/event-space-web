        ...
        <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
            ...
            <div v-if="result"
                ...
                <article v-for="event in result.eventsByLocation" :key="event.id"
                    class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 pb-8 pt-80 sm:pt-48 lg:pt-80 border-2 border-background hover:border-primary">
